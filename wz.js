...
var notices = [
	...
	'* 大陆地区用户我们强烈建议您截图收藏当前页面(https://91.com)。'
];
...
window.onload = function () {
    ...
    logoElem.innerHTML = '9 <span>1</span><span class="flag">总部</span>'
    mainElem.appendChild(logoElem);

    // newest urls
    var newestFieldElem = createFieldElem({title: '最新地址', items: newestUrls, text: '请使用https://协议访问91总部'});
